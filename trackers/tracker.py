...
class Tracker:
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control):
        output_video_frames = []
        previous_ball_team = None
        team_pass_count = {1: 0, 2: 0}  # Initialize pass counters
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            # Check if a pass has been made
            for track_id, player in player_dict.items():
                if player.get('has_ball', False):
                    current_ball_team = player.get('team', None)
                    if previous_ball_team is not None and previous_ball_team != current_ball_team:
                        team_pass_count[previous_ball_team] += 1  # Increment pass count
                    previous_ball_team = current_ball_team
