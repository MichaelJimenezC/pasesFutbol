...
def main(input_path='input_videos/08fd33_4.mp4', output_path='output_videos/output_video.mp4'):
    ...
    print("📦 [2/14] Cargando modelo Tracker...")
    tracker = Tracker(
        'models/best.pt',
        imgsz=768,
        conf=0.25,
    ...
    print("🧭 [4/14] Añadiendo posiciones a los tracks...")
    tracker.add_position_to_tracks(tracks)
    print("✅ Posiciones añadidas.")

    print("🎥 [5/14] Estimando movimiento de cámara...")
    ...
    print("🧭 [6/14] Ajustando posiciones según movimiento de cámara...")
    camera_movement_estimator.add_adjust_positions_to_tracks(tracks, camera_movement_per_frame)
    print("✅ Posiciones ajustadas.")


    print("⚽ [7/14] Interpolando posiciones del balón...")
    tracks["ball"] = tracker.interpolate_ball_positions(tracks["ball"])
    print("✅ Posiciones del balón interpoladas.")


    print("👕 [8/14] Asignando colores de equipo...")
    ...
    print("👥 [9/14] Asignando equipos por jugador/frame...")
    ...
    print("🥎 [10/14] Asignando posesión del balón (crudo)...")
    ...
    print("🔢 [13/14] Contando pases (robusto)…")
    ...
    print("🎨 [14/14] Dibujando anotaciones (modo pases)…")
